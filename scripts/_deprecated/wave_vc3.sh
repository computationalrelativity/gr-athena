...
export REL_OUTPUT=outputs/wave_3d
...
export COMPILE_STR="--prob=wave_3d_cvg_trig -w -w_vc
                    --cxx g++
                    --nghost=4 --ncghost=5 --ncghost_cx=5 --nextrapolate=4"
...
tail -n5 ${DIR_OUTPUT}/wave_3d.hst
