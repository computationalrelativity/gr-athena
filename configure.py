...
#   -m1_weakrates       enable weakrates   (nu opacities)
#   -m1_bnsnurates      enable bns_nurates (nu opacities)
#
# Ejecta:
#
...
parser.add_argument(
  ...
  action="store_true",
  default=False,
  help="enable compilation of M1 weakrates opacities",
)

# -m1_bnsnurate argument
parser.add_argument(
  "-m1_bnsnurates",
  action="store_true",
  default=False,
...
if args["m1"]:
  print(
    "  M1 neutrino weakrates:        "
    + ("ON" if args["m1_weakrates"] else "OFF")
  )
  print(
    "  M1 neutrino bns_nurates:     "
    + ("ON" if args["m1_bnsnurates"] else "OFF")
  )
