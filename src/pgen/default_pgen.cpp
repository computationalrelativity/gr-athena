...
//  \brief Function called before each cycle for user-defined work.
//========================================================================================
...
void __attribute__((weak)) MeshBlock::InitUserMeshBlockData(
  ParameterInput* pin)
{
  // do nothing
  return;
...
void __attribute__((weak)) MeshBlock::UserWorkMeshUpdatedPrePostAMRHooks(
  ParameterInput* pin)
{
  // do nothing
  return;
