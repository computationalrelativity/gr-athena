...
namespace HydroIntegratorTaskNames {
  ...
  const uint64_t ADD_VISCFLX=1LL<<7;
  const uint64_t ADD_HEATFLX=1LL<<8;
  const uint64_t ADD_OHMFLX=1LL<<9;
  const uint64_t ADD_ADFLX=1LL<<10;
  const uint64_t ADD_HALLFLX=1LL<<11;

  const uint64_t SEND_HYDFLX=1LL<<12;
  const uint64_t SEND_FLDFLX=1LL<<13;
  const uint64_t SEND_RADFLX=1LL<<14;
  const uint64_t SEND_CHMFLX=1LL<<15;

  const uint64_t RECV_HYDFLX=1LL<<16;
  const uint64_t RECV_FLDFLX=1LL<<17;
  const uint64_t RECV_RADFLX=1LL<<18;
  const uint64_t RECV_CHMFLX=1LL<<19;

  const uint64_t SRCTERM_HYD=1LL<<20;
  const uint64_t SRCTERM_FLD=1LL<<21;
  const uint64_t SRCTERM_RAD=1LL<<22;
  const uint64_t SRCTERM_CHM=1LL<<23;

  const uint64_t INT_HYD=1LL<<24;
  const uint64_t INT_FLD=1LL<<25;
  const uint64_t INT_RAD=1LL<<26;
  const uint64_t INT_CHM=1LL<<27;
  const uint64_t INT_WAVE=1LL<<28;

  const uint64_t SEND_HYD=1LL<<29;
  const uint64_t SEND_FLD=1LL<<30;
  const uint64_t SEND_RAD=1LL<<31;
  const uint64_t SEND_CHM=1LL<<32;
  const uint64_t SEND_WAVE=1LL<<33;

  const uint64_t RECV_HYD=1LL<<34;
  const uint64_t RECV_FLD=1LL<<35;
  const uint64_t RECV_RAD=1LL<<36;
  const uint64_t RECV_CHM=1LL<<37;
  const uint64_t RECV_WAVE=1LL<<38;

  const uint64_t PROLONG =1LL<<39;
  const uint64_t CON2PRIM=1LL<<40;
  const uint64_t PHY_BVAL=1LL<<41;
  const uint64_t USERWORK=1LL<<42;
  const uint64_t NEW_DT  =1LL<<43;
  const uint64_t AMR_FLAG=1LL<<44;

  const uint64_t SOLV_GRAV=1LL<<45;
  const uint64_t SEND_GRAV=1LL<<46;
  const uint64_t RECV_GRAV=1LL<<47;
  const uint64_t CORR_GFLX=1LL<<48;

  const uint64_t STARTUP_INT=1LL<<49;
  const uint64_t UPDATE_DT  =1LL<<50;

  const uint64_t SEND_HYDSH=1LL<<51;
  const uint64_t SEND_EMFSH=1LL<<52;
  const uint64_t SEND_FLDSH=1LL<<53;
  const uint64_t RECV_HYDSH=1LL<<54;
  const uint64_t RECV_EMFSH=1LL<<55;
  const uint64_t RECV_FLDSH=1LL<<56;
  const uint64_t RMAP_EMFSH=1LL<<57;
