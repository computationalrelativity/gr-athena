#ifndef M1_OPACITIES_COMMON_FERMI_HPP
#define M1_OPACITIES_COMMON_FERMI_HPP
...
namespace M1::Opacities::Common::Fermi
{
//-----------------------------------------------------------------------
// FERMI 2
//-----------------------------------------------------------------------
...
inline Real fermi5p(Real eta)
{
  ...
  return (1.0 / 6.0 + k51 * x2 + k52 * x4 + k53 * x6) /
         (1.0 + exp(-k54 * eta));
}  // END FUNCTION
//-----------------------------------------------------------------------
...
#endif  // M1_OPACITIES_COMMON_FERMI_HPP
