...
//  \brief defines MeshRefinement class used for static/adaptive mesh
//  refinement
...
class MeshRefinement
{
  ...
  void RestrictVertexCenteredValues(const AthenaArray<Real>& fine,
                                    ...
                                    int csk,
                                    int cek);
  void RestrictTwiceToBufferVertexCenteredValues(const AthenaArray<Real>& fine,
                                                 Real* buf,
                                                 int sn,
                                                 int en,
                                                 int csi,
  ...
  void RestrictCellCenteredXWithInteriorValues(const AthenaArray<Real>& fine,
                                               AthenaArray<Real>& coarse,
                                               int sn,
                                               int en);
  ...
  void RestrictVertexCenteredIndicialHelper(int ix,
                                            int ix_cvs,
                                            int ix_cve,
                                            int ix_vs,
                                            int ix_ve,
  ...
  void ProlongateVertexCenteredIndicialHelper(int hs_sz,
                                              int ix,
                                              int ix_cvs,
                                              int ix_cve,
                                              int ix_cmp,
  ...
  static inline int sz_linspace(int num, bool staggered, int num_ghost)
  {
  ...
  static inline auto linspace(Tsta start,
                              Tsto stop,
                              int num,
                              bool staggered,
  ...
  // ctor
  typedef Floater_Hormann::interp_nd<Real, Real> interp_nd;
