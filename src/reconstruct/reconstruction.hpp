...
class Reconstruction
{
  ...
  AthenaArray<Real> c1i, c2i, c3i, c4i, c5i,
    c6i;  // coefficients for PPM in x1
  AthenaArray<Real> c1j, c2j, c3j, c4j, c5j,
    c6j;  // coefficients for PPM in x2
  AthenaArray<Real> c1k, c2k, c3k, c4k, c5k,
    c6k;  // coefficients for PPM in x3
  ...
  inline void SetIndicialLimitsCalculateFluxes(const int dir,
                                               int& il,
                                               int& iu,
                                               int& jl,
                                               int& ju,
  ...
  void ReconstructCeno5X1(AthenaArray<Real>& z,
                          AthenaArray<Real>& zl_,
                          AthenaArray<Real>& zr_,
                          const int n_tar,
                          const int n_src,
  ...
  void ReconstructCeno5X2(AthenaArray<Real>& z,
                          AthenaArray<Real>& zl_,
                          AthenaArray<Real>& zr_,
                          const int n_tar,
                          const int n_src,
  ...
  void ReconstructCeno5X3(AthenaArray<Real>& z,
                          AthenaArray<Real>& zl_,
                          AthenaArray<Real>& zr_,
                          const int n_tar,
                          const int n_src,
  ...
  void ReconstructLag6X1(AthenaArray<Real>& z,
                         AthenaArray<Real>& zl_,
                         AthenaArray<Real>& zr_,
                         const int n_tar,
                         const int n_src,
  ...
  void ReconstructLag6X2(AthenaArray<Real>& z,
                         AthenaArray<Real>& zl_,
                         AthenaArray<Real>& zr_,
                         const int n_tar,
                         const int n_src,
  ...
  void ReconstructLag6X3(AthenaArray<Real>& z,
                         AthenaArray<Real>& zl_,
                         AthenaArray<Real>& zr_,
                         const int n_tar,
                         const int n_src,
  ...
  void ReconstructWeno5zcplusX1(AthenaArray<Real>& z,
                                AthenaArray<Real>& zl_,
                                AthenaArray<Real>& zr_,
                                const int n_tar,
                                const int n_src,
  ...
  void ReconstructWeno5zcplusX2(AthenaArray<Real>& z,
                                AthenaArray<Real>& zl_,
                                AthenaArray<Real>& zr_,
                                const int n_tar,
                                const int n_src,
  ...
  void ReconstructWeno5zcplusX3(AthenaArray<Real>& z,
                                AthenaArray<Real>& zl_,
                                AthenaArray<Real>& zr_,
                                const int n_tar,
                                const int n_src,
  ...
  void ReconstructWeno5zcplusPwX1(AthenaArray<Real>& z,
                                  AthenaArray<Real>& zl_,
                                  AthenaArray<Real>& zr_,
                                  const int n_tar,
                                  const int n_src,
  ...
  void ReconstructWeno5zcplusPwX2(AthenaArray<Real>& z,
                                  AthenaArray<Real>& zl_,
                                  AthenaArray<Real>& zr_,
                                  const int n_tar,
                                  const int n_src,
  ...
  void ReconstructWeno5zcplusPwX3(AthenaArray<Real>& z,
                                  AthenaArray<Real>& zl_,
                                  AthenaArray<Real>& zr_,
                                  const int n_tar,
                                  const int n_src,
  ...
  void ReconstructWeno5ZPWX1(AthenaArray<Real>& z,
                             AthenaArray<Real>& zl_,
                             AthenaArray<Real>& zr_,
                             const int n_tar,
                             const int n_src,
  ...
  void ReconstructWeno5ZPWX2(AthenaArray<Real>& z,
                             AthenaArray<Real>& zl_,
                             AthenaArray<Real>& zr_,
                             const int n_tar,
                             const int n_src,
  ...
  void ReconstructWeno5ZPWX3(AthenaArray<Real>& z,
                             AthenaArray<Real>& zl_,
                             AthenaArray<Real>& zr_,
                             const int n_tar,
                             const int n_src,
  ...
  void ReconstructTeno5X1(AthenaArray<Real>& z,
                          AthenaArray<Real>& zl_,
                          AthenaArray<Real>& zr_,
                          const int n_tar,
                          const int n_src,
  ...
  void ReconstructTeno5X2(AthenaArray<Real>& z,
                          AthenaArray<Real>& zl_,
                          AthenaArray<Real>& zr_,
                          const int n_tar,
                          const int n_src,
  ...
  void ReconstructTeno5X3(AthenaArray<Real>& z,
                          AthenaArray<Real>& zl_,
                          AthenaArray<Real>& zr_,
                          const int n_tar,
                          const int n_src,
  ...
  void ReconstructTeno5mc2X1(AthenaArray<Real>& z,
                               AthenaArray<Real>& zl_,
                               AthenaArray<Real>& zr_,
                               const int n_tar,
                               const int n_src,
  ...
  void ReconstructTeno5mc2X2(AthenaArray<Real>& z,
                               AthenaArray<Real>& zl_,
                               AthenaArray<Real>& zr_,
                               const int n_tar,
                               const int n_src,
  ...
  void ReconstructTeno5mc2X3(AthenaArray<Real>& z,
                                AthenaArray<Real>& zl_,
                                AthenaArray<Real>& zr_,
                                const int n_tar,
                                const int n_src,
  ...
  void ReconstructTeno5korenX1(AthenaArray<Real>& z,
                               AthenaArray<Real>& zl_,
                               AthenaArray<Real>& zr_,
                               const int n_tar,
                               const int n_src,
  ...
  void ReconstructTeno5korenX2(AthenaArray<Real>& z,
                               AthenaArray<Real>& zl_,
                               AthenaArray<Real>& zr_,
                               const int n_tar,
                               const int n_src,
  ...
  void ReconstructTeno5korenX3(AthenaArray<Real>& z,
                                AthenaArray<Real>& zl_,
                                AthenaArray<Real>& zr_,
                                const int n_tar,
                                const int n_src,
