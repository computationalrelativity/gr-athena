...
enum Athena_MPI_Tag {TAG_HYDRO=0, TAG_FIELD=1, TAG_RAD=2, TAG_CHEM=3, TAG_HYDFLX=4,
  ...
  TAG_WAVE=16, TAG_Z4C=17};

enum BoundaryType {BNDRY_HYDRO=0, BNDRY_FIELD=1, BNDRY_GRAVITY=2, BNDRY_MGGRAV=3,
                   BNDRY_MGGRAVF=4, BNDRY_FLCOR=5, BNDRY_EMFCOR=6, BNDRY_WAVE=7, BNDRY_Z4C=8};
enum CCBoundaryType {HYDRO_CONS=0, HYDRO_PRIM=1, WAVE_SOL=2, Z4C_SOL=3};
