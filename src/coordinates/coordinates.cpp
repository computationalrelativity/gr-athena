    ...
    : pmy_block(pmb), coarse_flag(flag), pm(pmb->pmy_mesh)
{
  ...
  else
  {
    ...
    nv1 = pmy_block->nverts1, nv2 = pmy_block->nverts2,
    nv3 = pmy_block->nverts3;
  }
  ...
  {  // exclude: minkowski, schwarzschild, kerr-schild, gr_dynamical
  ...
  // condition
  if (pmy_block->nc().boundary_flag(BoundaryFace::inner_x1) ==
  ...
  if (pmy_block->nc().boundary_flag(BoundaryFace::outer_x1) ==
      BoundaryFlag::reflect)
  {
    for (int i = 1; i <= ng; ++i)
    {
  ...
  if (nc2 > 1)
  {
    ...
    // condition
    if (pmy_block->nc().boundary_flag(BoundaryFace::inner_x2) ==
          BoundaryFlag::reflect ||
        pmy_block->nc().boundary_flag(BoundaryFace::inner_x2) ==
          BoundaryFlag::polar)
    {
      for (int j = 1; j <= ng; ++j)
      {
    ...
    if (pmy_block->nc().boundary_flag(BoundaryFace::outer_x2) ==
          BoundaryFlag::reflect ||
        pmy_block->nc().boundary_flag(BoundaryFace::outer_x2) ==
          BoundaryFlag::polar)
    {
      for (int j = 1; j <= ng; ++j)
      {
  ...
  if (nc3 > 1)
  {
    ...
    // correct cell face coordinates in ghost zones for reflecting boundary
    // condition
    if (pmy_block->nc().boundary_flag(BoundaryFace::inner_x3) ==
        BoundaryFlag::reflect)
    {
      for (int k = 1; k <= ng; ++k)
      {
    ...
    if (pmy_block->nc().boundary_flag(BoundaryFace::outer_x3) ==
        BoundaryFlag::reflect)
    {
      for (int k = 1; k <= ng; ++k)
      {
...
//----------------------------------------------------------------------------------------
// CenterWidthX functions: return physical width in X-dir at (i,j,k)
// cell-center
