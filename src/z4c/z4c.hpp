...
// For example g_dd is a tensor, or tensor-like object, with two covariant
// indices.
...
class Z4c
{
  ...
  static constexpr char const* const Z4c_names[] = {
    "geom.z4c.chi",   "geom.z4c.gxx",   "geom.z4c.gxy",   "geom.z4c.gxz",
    "geom.z4c.gyy",   "geom.z4c.gyz",   "geom.z4c.gzz",   "geom.z4c.Khat",
    "geom.z4c.Axx",   "geom.z4c.Axy",   "geom.z4c.Axz",   "geom.z4c.Ayy",
    "geom.z4c.Ayz",   "geom.z4c.Azz",   "geom.z4c.Gamx",  "geom.z4c.Gamy",
    "geom.z4c.Gamz",  "geom.z4c.Theta", "geom.z4c.alpha", "geom.z4c.betax",
    "geom.z4c.betay", "geom.z4c.betaz",
  };
  ...
  static constexpr char const* const ADM_names[] = {
    "geom.adm.alpha", "geom.adm.betax", "geom.adm.betay", "geom.adm.betaz",
    "geom.adm.gxx",   "geom.adm.gxy",   "geom.adm.gxz",   "geom.adm.gyy",
    "geom.adm.gyz",   "geom.adm.gzz",   "geom.adm.Kxx",   "geom.adm.Kxy",
    "geom.adm.Kxz",   "geom.adm.Kyy",   "geom.adm.Kyz",   "geom.adm.Kzz",
    "geom.adm.psi4"
  };
  ...
  static constexpr char const* const Constraint_names[] = {
    "geom.con.C",  "geom.con.H",  "geom.con.M",  "geom.con.Z",
  ...
  static constexpr char const* const Matter_names[] = {
    "geom.mat.rho", "geom.mat.Sx",  "geom.mat.Sy",  "geom.mat.Sz",
    "geom.mat.Sxx", "geom.mat.Sxy", "geom.mat.Sxz", "geom.mat.Syy",
    "geom.mat.Syz", "geom.mat.Szz",
  };
  ...
  static constexpr char const* const Aux_names[] = {
    "aux.dalpha_x", "aux.dalpha_y", "aux.dalpha_z", "aux.dbetax_x",
    "aux.dbetay_x", "aux.dbetaz_x", "aux.dbetax_y", "aux.dbetay_y",
    "aux.dbetaz_y", "aux.dbetax_z", "aux.dbetay_z", "aux.dbetaz_z",
    "aux.dgxx_x",   "aux.dgxy_x",   "aux.dgxz_x",   "aux.dgyy_x",
    "aux.dgyz_x",   "aux.dgzz_x",   "aux.dgxx_y",   "aux.dgxy_y",
    "aux.dgxz_y",   "aux.dgyy_y",   "aux.dgyz_y",   "aux.dgzz_y",
    "aux.dgxx_z",   "aux.dgxy_z",   "aux.dgxz_z",   "aux.dgyy_z",
    "aux.dgyz_z",   "aux.dgzz_z",
  };
  ...
  struct
  {
    ...
    Real chi_div_floor;  // puncture's floor value for chi, use max(chi,
                         // chi_div_floor) in non-differentiated chi
  ...
  void WeightedAve(AA& u_out, AA& u_in1, AA& u_in2, const Real wght[3]);
  // add RHS to state
  ...
  void PrepareAuxExtended(AA& u_aux_extended,
                          AA& u,
                          AA& u_adm,
                          const int il,
                          const int iu,
  ...
  inline Real psi4Regularized(const Real& psi4_bare)
  {
    ...
    const Real psi4_guarded =
      (std::isfinite(psi4_bare)) ? std::min(T_psi4, psi4_bare) : T_psi4;
    return psi4_guarded;
  }
  ...
  void GetMatter(AA& u_mat, AA& u_adm, AA& w, AA& r, AA& bb_cc);
  ...
  // 3D second-derivative storage for chi (avoids recomputing in
  // RHS/Constraints/Weyl)
