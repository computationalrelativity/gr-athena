...
void Z4c::ADMToZ4c(AthenaArray<Real> & u_adm, AthenaArray<Real> & u)
{
  ...
  AthenaTensor<Real, TensorSymm::NONE, NDIM, 3> Ga_duu;
  Ga_duu.NewAthenaTensor(ncells3, ncells2, ncells1);
  ...
  ILOOP2(k,j) {
    ...
    for(int b = 0; b < NDIM; ++b) {
      ILOOP1(i) {
        ...
        Ga_duu(c,a,b,k,j,i) -= FD.Dx(c, g_uu(a,b,k,j,i));
...
....................................
  ...
  for(int b = 0; b < NDIM; ++b) {
    ILOOP1(i) {
      z4c.Gam_u(a,k,j,i) += g_uu(c,f,k,j,i)*z4c.g_dd(b,e,k,j,i)*Ga_duu(f,a,e,k,j,i)
    }
  }
  }

  Gam_duu.DeleteAthenaTensor();
