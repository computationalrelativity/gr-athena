...
/// energy/momentum inversion failed. Keep them and discard the ambiguous
/// part (velocity, temperature). A NaN seed marks an unusable conserved
/// state: full atmosphere reset.
