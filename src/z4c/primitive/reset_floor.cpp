...
bool ResetFloor::PrimitiveFloor(Real& n,
                                Real v[3],
                                Real& T,
                                Real* Y,
                                int n_species)
...
bool ResetFloor::ConservedFloor(Real& D,
                                Real Sd[3],
                                Real& tau,
                                Real* Y,
                                Real D_floor,
...
bool ResetFloor::DensityLimits(Real& n, Real n_min, Real n_max)
{
  Real n_old = n;
...
bool ResetFloor::TemperatureLimits(Real& T, Real T_min, Real T_max)
{
  Real T_old = T;
...
bool ResetFloor::PressureLimits(Real& P, Real P_min, Real P_max)
{
  Real P_old = P;
...
bool ResetFloor::EnergyLimits(Real& e, Real e_min, Real e_max)
{
  Real e_old = e;
...
bool ResetFloor::SpeciesLimits(Real* Y,
                               Real* Y_min,
                               Real* Y_max,
                               int n_species)
{
