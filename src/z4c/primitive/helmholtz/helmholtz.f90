...
! end of pipeline loop
   ...
   subroutine check_bounds(&
     rho_trans, temp_trans, ye_min, ye_max, success&
   ) bind(C, name="check_bounds")
      implicit none
      include 'helm_table_storage.dek'
      real(8), intent(in) :: rho_trans, temp_trans, ye_min, ye_max
      logical, intent(out) :: success
    ...
    subroutine get_bounds(&
      ...
      implicit none
      include 'helm_table_storage.dek'
      real(8), intent(in) :: ye_min
      real(8), intent(out) :: rho_min, temp_min
      real(8), intent(out) :: rho_max, temp_max
