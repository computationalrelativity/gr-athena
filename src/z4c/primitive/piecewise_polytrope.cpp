...
Real PiecewisePolytrope::InteractionPotentialDifference(Real n, Real T, Real *Y) {
  throw std::logic_error("PiecewisePolytrope::InteractionPotentialDifference not currently implemented.");
}
