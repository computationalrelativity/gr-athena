#ifndef COLDEOS_COMPOSE_TRANSITION_H
#define COLDEOS_COMPOSE_TRANSITION_H

//! \file eos_compose_transition.hpp
...
class ColdEOSCompOSETransition {
  public:
    enum TableVariables {
