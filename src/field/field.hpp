...
class Field
{
  ...
  void CalculateCellCenteredField(const FaceField& bf,
                                  AthenaArray<Real>& bc,
                                  Coordinates* pco,
                                  int il,
                                  int iu,
  ...
  struct ixn_derived_ms
  {
    ...
    static constexpr char const* const names[] = {
      "field.aux.B2",       "field.aux.b0",     "field.aux.b2",
      "field.aux.b_u_1",    "field.aux.b_u_2",  "field.aux.b_u_3",
      "field.aux.mag",      "field.aux.plbeta", "field.aux.lambda_mri",
      "field.aux.Alfven_v",
    };
  };
